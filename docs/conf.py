...
html_theme_options = {
    ...
    "extra_nav_links": {
        "base32-lib@GitHub": "http://github.com/inveniosoftware/base32-lib",
        "base32-lib@PyPI": "http://pypi.python.org/pypi/base32-lib/",
    },
}
...
htmlhelp_basename = "base32-lib_namedoc"
...
man_pages = [(master_doc, "base32-lib", "base32-lib Documentation", [author], 1)]
